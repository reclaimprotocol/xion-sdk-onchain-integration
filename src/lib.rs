...
mod tests {
    ...
    use crate::msg::{InstantiateMsg, QueryMsg, ExecuteMsg, ProofMsg, GetAllEpochResponse, GetEpochResponse};
    ...
    fn example_verification_test() {
        ...
        let reclaim_verifier: ReclaimVerifier<Mock> = ReclaimVerifier::new("test_verifier", chain.clone());
        ...
        let claim_data = CompleteClaimData {
